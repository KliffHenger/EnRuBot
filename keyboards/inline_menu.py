...
BTN_ENG_LEVEL = InlineKeyboardButton('\U0001F4DA Level of English', callback_data='eng_level')
BTN_TIME_SLOT = InlineKeyboardButton('\U0001F551 Timeslot', callback_data='timeslot')
BTN_STATISTICS = InlineKeyboardButton('\U0001F4C8 Statistics', callback_data='statistics')
