...
KB_MENU = InlineKeyboardMarkup().add(BTN_FIND_INTERLOCUTOR).add(BTN_ENG_LEVEL).add(BTN_TIME_SLOT).add(BTN_STATISTICS).add(BTN_HOUR_GOAL).add(BTN_INSTR).add(BTN_SET_CITY)
